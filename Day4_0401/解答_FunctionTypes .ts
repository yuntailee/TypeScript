...
export type HttpMethod = "GET"|"POST"|"PUT"|"DELETE"; // 請修改這行

// 2. 定義 callback 函式的型別：接收一個字串參數 (data)，沒有回傳值
export type SuccessCallback = (data:string)=>void; // 請修改這行
...
export function fetchData(
  url: string, // 請修改型別
  method:  HttpMethod= "GET", // 請修改型別
  onSuccess?: SuccessCallback // 請修改型別
): void {
